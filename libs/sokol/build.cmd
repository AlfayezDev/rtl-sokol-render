...
REM D3D11 Release
for %%s in (%sources%) do (
    cl /c /O3 /DNDEBUG /DIMPL /DSOKOL_D3D11 c\sokol_%%s.c
...
REM GL Release
for %%s in (%sources%) do (
    cl /c /O3 /DNDEBUG /DIMPL /DSOKOL_GLCORE c\sokol_%%s.c
...
cl /O3 /DNDEBUG /DIMPL /DSOKOL_DLL /DSOKOL_D3D11 c\sokol.c /LD /MD /DLL /Fe:sokol_dll_windows_x64_d3d11_release.dll /link /INCREMENTAL:NO
...
REM GL Release DLL
cl /O3 /DNDEBUG /DIMPL /DSOKOL_DLL /DSOKOL_GLCORE c\sokol.c /LD /MD /DLL /Fe:sokol_dll_windows_x64_gl_release.dll /link /INCREMENTAL:NO
